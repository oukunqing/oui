        ...
        OUI.extend = OUI.fn.extend = function() {
            ...
            for (; i < length; i++) {
                ...
                for (name in source) {
                    ...
                    if (
                        deep &&
                        ((copyIsArray = isArray(copy)) || isObject(copy))
                    ) {
                        if (copyIsArray) {
                            copyIsArray = false;
...
!(function($) {
    ...
    var version = "1.0.0",
        ...
        isString = function(s, nonempty) {
            return typeof s === "string" && (nonempty ? trim(s) !== "" : true);
        },
        isNumber = function(n) {
        ...
        isFunction = function(f) {
            return typeof f === "function" && typeof f.nodeType !== "number";
        },
        ...
        isHexNumeric = function(o) {
            return /^(0x)?[\dA-F]+$/gi.test(o);
        },
        isHexNumber = function(o) {
            return isNumber(o) && isHexNumeric(o);
        },
        isRegexp = function(o) {
        ...
        isProperty = function(o, property) {
            return o.hasOwnProperty(property) && property in o;
        },
        ...
        toDecimal = function(s, defaultValue, decimalLen) {
            ...
            v =
                !isNaN(v) && $.isInteger(decimalLen)
                    ? v.round(Math.abs(decimalLen))
                    : v;
        ...
        toNumber = function(s, defaultValue, isFloat, decimalLen) {
            ...
            if ($.isNumeric(dv)) {
                if ($.isInteger(isFloat)) {
                    ...
                    decimalLen = $.isInteger(decimalLen)
                        ? decimalLen
                        : (dv.toString().split(".")[1] || "").length;
                }
            } else if ($.isBoolean(dv)) {
                (decimalLen = $.isInteger(isFloat)
                    ? isFloat
                    : decimalLen), (isFloat = dv), (dv = 0);
            } else {
                isFloat = $.isBoolean(
                    isFloat,
                    pattern.test(dv) || pattern.test(s)
                );
            }
        ...
        contains = function(obj, key, value) {
            if (isObject(obj)) {
                return (
                    containsKey(obj, key) &&
                    (isNullOrUndefined(value) || containsValue(obj, value))
                );
            } else if (isArray(obj)) {
                return obj.indexOf(value) >= 0;
            }
        ...
        expandNumberList = function(
            ...
            var list = [],
                arr = collapsedNumbers.split(separator || ",");
        ...
        toAsciiHex = function(argv, isJoin) {
            ...
            var hex = [],
                arr = $.isArray(argv) ? argv : toAscii(argv),
                len = arr.length,
                idx = 0;
            for (var i = 0; i < len; i++) {
                var v = arr[i];
        ...
        _buildParam = function(url, s, key, val, oldVal) {
            if (!isNullOrUndefined(val)) {
                var ps =
                    key +
                    "=" +
                    toEncode(isObject(val) ? toJsonString(val) : val);
                if (oldVal !== "") {
        ...
        buildParam = function(a, v, strict, url) {
            ...
            if (
                isNullOrUndefined(a) ||
                (!isObj && isStrict && isNullOrUndefined(v))
            ) {
                return isUrl ? url : "";
            }
            if (isString(a)) {
            ...
            if (isArray(a)) {
                for (var i = 0, c = a.length; i < c; i++) {
                    var key = a[i].key || a[i].name,
                        val = a[i].value || a[i].data || a[i].val;
        ...
        getQueryString = function(url, name) {
            var str = isString(url) ? url : location.href,
        ...
        padLeft = function(s, totalWidth, paddingChar, isRight) {
            var char = paddingChar || "0",
                c = totalWidth - s.length;
            for (var i = 0; i < c; i++) {
    ...
    var counter = 1,
        debug = isBoolean(isDebug(), true);
    $.extendNative = $.fn.extendNative = function(
        destination,
        source,
        constructor
    ) {
        ...
        var log = debug,
            con = constructor,
            native = isString(con),
            force = isBoolean(constructor, false);
        for (var property in source) {
            var extend = force || isUndefined(destination[property]),
                obj = source[property];
            if (extend) {
    ...
    $.extendNative(
        $,
        {
            ...
            isNullOrUndef: isNullOrUndefined,
            isUndefinedOrNull: isNullOrUndefined,
            isUndefOrNull: isNullOrUndefined,
            isEmpty: function(o, strict) {
                if (strict) {
                    return isString(o) && "" === trim(o);
                }
                if (isUndefined(o) || null === o) {
                    return true;
                } else if (isString(o)) {
                    return "" === trim(o);
                } else if (isArray(o)) {
            ...
            collapseNumberList: collapseNumberList,
            expandNumberList: expandNumberList,
            collapseNumbers: collapseNumberList,
            expandNumbers: expandNumberList,
            ...
            keyOverload: keywordOverload,
            setValue: setValue,
            getValue: getValue,
            isValue: isValue,
            getParam: getParam,
            getParamValue: getParamValue,
            getParVal: getParamValue,
            cleanSlash: cleanSlash,
            ...
            quickSort: function(arr, key) {
                ...
                return this.quickSort(left, key).concat(
                    pivot,
                    this.quickSort(right, key)
                );
            },
    ...
    function CRC() {
        ...
        return {
            toCRC16: function(s, isReverse, isHex) {
                return toHex(
                    CRC16(isHex ? strToHexByte(s) : strToByte(s), isReverse),
                    4
                );
            },
        ...
        $,
        {
            numberToChinese: function(num, isMoney) {
                ...
                var chars = isMoney
                    ...
                    toChinese = function(txt, isMoney, isDecimal) {
                        ...
                        var str = [],
                            len = txt.length - 1;
                        for (var i = 0; i <= len; i++) {
                            var num = parseInt(txt[i], 10),
                                pos = len - i,
                                unit = isDecimal ? decimals[i] : units[pos];
                            if (
                                num === 0 &&
                                (i === len || txt[i + 1] === "0")
                            ) {
                ...
                if (isMoney) {
                    ...
                    res.push(
                        arr[1] ? toChinese(arr[1], isMoney, true) : others.int
                    );
                } else {
                    res.push(
                        arr[1] ? dot + toChinese(arr[1], isMoney, true) : ""
                    );
                }
                return res.join("");
            },
            ...
            chineseToUnicode: function(str, returnArray, noPrefix) {
                var arr = $.isArray(str) ? str : str.split(""),
                    len = arr.length,
                    res = [];
                for (var i = 0; i < len; i++) {
...
!(function($) {
    ...
    $.extendNative($, {
        ...
        isDateObject: function(dt) {
            if (
                typeof dt === "object" &&
                typeof dt.getFullYear === "function"
            ) {
                return true;
            }
            return false;
        ...
        getMonthEnd: function(month, year) {
            ...
            if (ds !== null) {
                ...
                return "{0}-{1:D2}-{2:D2} 23:59:59".format(
                    ds.year,
                    ds.month,
                    days
                );
        ...
        getDayStart: function(date, month, year) {
            ...
            if (ds !== null) {
                return "{0}-{1:D2}-{2:D2} 00:00:00".format(
                    ds.year,
                    ds.month,
                    ds.date
                );
    ...
    $.extendNative(
        String.prototype,
        {
            ...
            padStart: function(totalWidth, paddingChar) {
                return $.padLeft(this, totalWidth, paddingChar || " ");
            },
            padEnd: function(totalWidth, paddingChar) {
                return $.padRight(this, totalWidth, paddingChar || " ");
            },
            padLeft: function(totalWidth, paddingChar) {
                return $.padLeft(this, totalWidth, paddingChar || "0");
            },
            padRight: function(totalWidth, paddingChar) {
                return $.padRight(this, totalWidth, paddingChar || "0");
            },
            ...
            replaceAll: function(pattern, v) {
                return this.replace(
                    $.isRegexp(pattern) ? pattern : new RegExp(pattern, "gm"),
                    v
                );
            },
            append: function(v, c) {
        ...
        */
            ...
            isHexNumeric: function() {
                return $.isHexNumeric(this);
            },
            isPercent: function() {
                return $.isPercent(this);
            },
            isTelephone: function() {
                return $.isTelephone(this);
            },
            isMobile: function() {
            ...
            isNaN: function() {
                return isNaN(parseFloat(this, 10));
            },
            toBoolean: function(val) {
                return $.toBoolean(
                    this,
                    typeof val === "undefined" ? this : val
                );
            },
            toBool: function(val) {
                return $.toBoolean(
            ...
            toNumber: function(defaultValue, isFloat, decimalLen) {
                return $.toNumber(this, defaultValue, isFloat, decimalLen);
            },
            toNumberList: function(separator, decimalLen) {
                return $.toNumberList(this, separator, decimalLen);
            },
            toInt: function(defaultValue) {
                return $.toInteger(this, defaultValue);
            },
            toInteger: function(defaultValue) {
                return $.toInteger(this, defaultValue);
            },
            toFloat: function(defaultValue, decimalLen) {
                return $.toDecimal(this, defaultValue, decimalLen);
            },
            toDecimal: function(defaultValue, decimalLen) {
                return $.toDecimal(this, defaultValue, decimalLen);
            },
            round: function(decimalLen) {
                return $.toNumber(this).round(decimalLen);
            },
            expandNumberList: function() {
                return $.expandNumberList(this);
            },
            toChineseNumber: function(isMoney) {
                return $.numberToChinese(this, isMoney);
            },
            chineseToNumber: function(isMoney) {
                return $.chineseToNumber(this, isMoney);
            },
            convertChineseToNumber: function() {
                return $.chineseToNumber(this);
            },
            chineseToUnicode: function(returnArray, noPrefix) {
                return $.chineseToUnicode(this, returnArray, noPrefix);
            },
            unicodeToChinese: function(returnArray) {
                return $.unicodeToChinese(this, returnArray);
            },
            asciiToUnicode: function(returnArray) {
                return $.asciiToUnicode(this, returnArray);
            },
            unicodeToAscii: function(returnArray) {
                return $.unicodeToAscii(this, returnArray);
            },
            firstLetterCapital: function() {
                var s = this.toLowerCase(),
                    f = s.substr(0, 1).toUpperCase();
                return f + s.substr(1);
            },
            toThousand: function(delimiter, len) {
                ...
                var a = s.split("."),
                    hasPoint = s.indexOf(".") >= 0;
                var reg = new RegExp(
                    "\\B(?=(?:[\\dA-Fa-f]{" + (len || 3) + "})+$)",
                    "gi"
                );
                return (
                    a[0].replace(reg, delimiter || ",") +
                    (hasPoint ? "." + (a[1] || "") : "")
                );
            },
            toFileSize: function() {
            ...
            toArray: function(delimiter, type, keepZero, distinct) {
                ...
                var d = typeof delimiter === "string" ? delimiter : ",|",
                    keep = $.isBoolean(keepZero, true),
                    distinct = $.isBoolean(distinct, false),
                    reg = new RegExp("([" + d + "]){2,}", "g"),
                    p1 = "[\\s]{0,}",
                    p2 = "[" + d + "]+",
                    //清除空项和首尾分隔符
                    s = this.replace(reg, "$1").replace(
                        new RegExp(
                            "(^" + p1 + p2 + ")|(" + p2 + p1 + "$)",
                            "g"
                        ),
                    ...
                    //判断是否要转换成数字
                    isNumber =
                        ["number", "int", "float"].indexOf(type) >= 0 ||
                        new RegExp("^([-\\d\\s." + d + "]+)$").test(s),
                    isInt = type === "int",
                    arr = s.split(new RegExp("[" + d + "]")),
                    c = arr.length,
                    list = [],
                    dic = new Dictionary();
                for (var i = 0; i < c; i++) {
            ...
            */
            ...
            compareTo: function(obj) {
                var p = /^[-+]?(\d+)(.[\d]{0,})?$/,
                    s1 = p.test(this) ? Number(this) : this,
                    s2 = p.test(obj) ? Number(obj) : obj;
            ...
            floatToHex: function(reverse) {
                ...
                return $.padLeft(
                    parseInt(signStr + exponentStr + fractionStr, 2).toString(
                        16
                    ),
                    8
                ).reverseHex(reverse);
        ...
        Number.prototype,
        {
            ...
            mul: function(arg) {
                var a = this.getDecimalLen(),
                    ...
                    m = a + b;
                return (
                    this.delDecimalPoint() *
                    arg.delDecimalPoint() /
                    Math.pow(10, m)
                );
            },
            div: function(arg) {
                var a = this.delDecimalPoint(),
                    b = arg.delDecimalPoint(),
                    n = this.getDecimalLen(),
                    m = arg.getDecimalLen();
            ...
            toAscii: function() {
                return this.toString().charCodeAt();
            },
            ...
            toAsciiHex: function() {
                return $.toAsciiHex(this, true);
            },
            toThousand: function(delimiter, len) {
                return this.toString().toThousand(delimiter, len);
            },
            toChineseNumber: function(isMoney) {
                return $.numberToChinese(this, isMoney);
            },
            ...
            toDateString: function(format) {
                return this.toString().toDateString(format);
            },
            toDateFormat: function(format) {
                return this.toString().toDateFormat(format);
            },
    ...
    $.extendNative(
        Date.prototype,
        {
            format: function(formatString, len) {
                ...
                if (
                    ["timestamp", "time", "tick", "ts"].indexOf(formatString) >=
                    0
                ) {
                    return $.isNumber(len)
                        ? t.getTime().toString().substr(0, len)
                        : t.getTime().toString();
                ...
                return (formatString || "yyyy-MM-dd HH:mm:ss")
                    .replace(p, function(matches) {
                        return d[matches];
                    });
            },
            ...
            addYears: function(v) {
                return this.setYear(
                    this.getFullYear() + (parseInt(v, 10) || 0)
                ), this;
            },
            addMonths: function(v) {
                return this.setMonth(
                    this.getMonth() + (parseInt(v, 10) || 0)
                ), this;
            },
            addDays: function(v) {
            ...
            getAge: function(dtNow) {
                if (
                    !dtNow ||
                    typeof dtNow.isDate === "undefined" ||
                    !dtNow.isDate()
                ) {
                    dtNow = new Date();
                }
                var age = dtNow.getFullYear() - this.getFullYear();
                var m1 = dtNow.getMonth(),
                    m2 = this.getMonth(),
                    d1 = dtNow.getDate(),
                    d2 = this.getDate();
            ...
            getMonthStart: function() {
                return $.getMonthStart(this);
            },
            getMonthEnd: function() {
                return $.getMonthEnd(this);
            },
            getDayStart: function() {
                return $.getDayStart(this);
            },
            getDayEnd: function() {
                return $.getDayEnd(this);
            }
        },
        "Date.prototype"
    );
            ...
            timeTick: function(tick) {
                var add = function(v, type) {
                        ...
                        return Date.timeTick(
                            Date.addTick(this.ticks / 10000, v, type)
                        );
                    },
                    show = function(formatString, hideMilliseconds) {
                        var s = this,
                            fs = formatString,
                            hide = hideMilliseconds;
                        if (
                        ...
                        if (
                            ...
                            var a = [
                                ...
                                p = s.days
                                    ...
                                    : s.hours
                                      ? 1
                                      : s.minutes ? 2 : s.seconds ? 3 : 4,
                                len = a.length - (hide ? 1 : 0);
                            if (fs === "en") {
                                a = [
                                    "{days}days ",
                                    "{hours}h ",
...
!(function($) {
    ...
    var throwError = function(msg, str, args) {
        ...
        scientificNotation = function(v, f, n, dn, numLen) {
            var num = parseInt("0" + dn[0], 10),
                fn = num < 1 ? 1 : dn[0].substr(0, 1),
                e = Math.pow(10, n),
                en = v.toString().substr(1).replace(".", ""),
                el = en.length,
                postfix = "001",
                postfixLen = f === "g" || f === "G" ? 2 : 3,
                prefix = "",
                symbol = num >= 1 ? "+" : "-";
            if (el > n) {
                if (en.indexOf("0") === 0) {
            ...
            if (num >= 1) {
                postfix = numLen - 1;
                for (var i = postfix.toString().length; i < postfixLen; i++) {
                    postfix = "0" + postfix;
                }
            }
            var so = { g: "e", G: "E" };
        ...
        formatNumberSwitch = function(v, f, n, dn, err, str, args, freedom) {
            ...
            if (isHexNumber(v) && regPattern.numberSymbol.test(fu)) {
                (v = parseInt(v, 10)), (dn = v.toString().split(".")), (numLen =
                    dn[0].length);
            }
            if (["C", "F", "N"].indexOf(fu) >= 0) {
                v =
                    decimalLen > n && decimalLen > 0
                        ? v.round(n)
                        : decimalLen === 0 && n > 0 ? v + "." : v;
            }
            var vc = v.toString(),
                len = vc.length;
            switch (fu) {
                ...
                case "N": //千位分隔
                    v =
                        (fu === "C" ? "¥" : "") +
                        vc.toThousand().append("0", n - decimalLen);
                    break;
                case "D": //整数
                    if (/([.])/g.test(v)) {
                ...
                case "G": //标准数字
                    v =
                        numLen === n
                            ...
                            : numLen < n
                              ? v.round(n - numLen)
                              : scientificNotation(v, f, n - 1, dn, numLen);
                    break;
                case "P":
                case "%": //百分比
                    v = v.mul(100).round(n) + "%";
        ...
        isNumberString = function(obj, f) {
            return (
                $.isNumber(obj) ||
                (!regPattern.numberSymbol.test(f) &&
                    regPattern.number.test(obj))
            );
        },
        isHexNumber = function(obj, f) {
            return (
                !regPattern.numberSymbol.test(f) && regPattern.number.test(obj)
            );
        },
        formatNumber = function(mv, v, err, str, args) {
            ...
            var isNum = isNumberString(v, f),
                sc = mv.match(/(:)/g).length,
                isColon = mv.toString().indexOf("::") > 0;
            if (sc > 1 && !isColon) {
                if (isNum) {
                    var nv = Math.round(v, 10),
                        pos = mv.indexOf(":"),
                        arv = mv.substr(pos + 1).split(""),
                        arn = nv.toString().split("");
                ...
                if (
                    ...
                    v = formatNumberSwitch(
                        ...
                        str,
                        args,
                        ss.endsWith(".") || ss.endWith("-")
                    );
                } else if (
                    (ss.length === 1 && p2.test(ss)) ||
                    (ss.length >= 2 && p4.test(ss))
                ) {
                    throwError(err[3], str, args);
                } else if (/([0]+)/g.test(ss)) {
                    var nv = Math.round(v, 10),
        ...
        distillObjVal = function(key, obj, err, str, vals) {
            ...
            return $.isObject(v)
                ? !$.isUndefined(dv) ? dv : throwError(err, str, vals)
                : v;
        };
        ...
        String.prototype.format = function(args) {
            ...
            for (var i = 0; i < mc; i++) {
                var m = matchs[i],
                    ...
                    p = s.indexOf(m),
                    idx = parseInt(mv, 10);
                var c = /{/g.test(m) ? m.match(/{/g).length : 0,
...
!(function($) {
    ...
    var win = (function() {
        ...
        isElement = function(elem, tagName) {
            ...
            return (
                isElem &&
                ($.isString(tagName, true) ? elem.tagName === tagName : isElem)
            );
        },
        ...
        addNamePostfix = function(filePath, postfix) {
            ...
            if (filePath.lastIndexOf(".") < 0) {
                ...
                var ext = getExtension(filePath),
                    len = ext.length;
                return (
                    filePath.substr(0, filePath.length - len) + postfix + ext
                );
            }
        },
        checkFilePath = function(filePath) {
            ...
            if (tmp.startWith("http://")) {
                return (
                    filePath.substr(0, 7) +
                    filePath.substr(7).replace(/[\/]{2,}/g, "/")
                );
            } else if (tmp.startWith("https://")) {
                return (
                    filePath.substr(0, 8) +
                    filePath.substr(8).replace(/[\/]{2,}/g, "/")
                );
            } else {
        ...
        createElement = function(nodeName, id, func, parent, options) {
            ...
            if (
                $.isUndefined(options) &&
                (($.isObject(parent) && !$.isElement(parent)) ||
                    $.isArray(parent))
            ) {
                options = parent;
                parent = undefined;
            ...
            return parent && parent.appendChild(elem), $.isFunction(func) &&
                func(elem, opt.param), elem;
        },
        ...
        createJsScript = function(data, id, func, parent) {
            ...
            var elem = createElement(
                ...
                id,
                function(elem) {
                    (elem.innerHTML = data), setAttribute(
                        elem,
        ...
        getElementStyle = function(elem, styleName, defaultValue) {
            ...
            return $.isString(styleName, true)
                ? $.checkValue(style[styleName], defaultValue)
                : style;
        },
        ...
        getElementStyleSize = function(elem, styleName) {
            ...
            data =
                attr === "radius"
                    ? {
                          topLeft: getCssSizeVal(
                              style["borderTopLeft" + postfix]
                          ),
                          topRight: getCssSizeVal(
                              style["borderTopRight" + postfix]
                          ),
                          bottomLeft: getCssSizeVal(
                              style["borderBottomLeft" + postfix]
                          ),
                          bottomRight: getCssSizeVal(
                              style["borderBottomRight" + postfix]
                          )
                      }
                    : {
                          top: getCssSizeVal(style[attr + "Top" + postfix]),
                          right: getCssSizeVal(style[attr + "Right" + postfix]),
                          bottom: getCssSizeVal(
                              style[attr + "Bottom" + postfix]
                          ),
        ...
        getCssAttrSize = function(val, options) {
            ...
            if (p.attr === "style") {
                ...
                ["padding", "margin", "border", "radius"].indexOf(p.attr) < 0
            ) {
                var v = isElem
                    ? getElementStyleSize(val, p.attr)
                    : getCssSizeVal(val);
                if (p.unit) {
                    v += p.unit;
                }
            ...
            for (var i in data) {
                ...
                if (p.isLimit) {
                    data[i] =
                        data[i] > p.max || data[i] < p.min ? p.val : data[i];
                }
                if (p.unit) {
                    data[i] += p.unit;
                }
            ...
            if (p.attr !== "radius") {
                data[p.attr + "Width"] =
                    getCssSizeVal(data.left) + getCssSizeVal(data.right);
                data[p.attr + "Height"] =
                    getCssSizeVal(data.top) + getCssSizeVal(data.bottom);
            }

            return p.isArray ? list : data;
        },
        getStyleSize = function(elem, options) {
            return getCssAttrSize(
                elem,
                $.extend({}, options, { attr: "style" })
            );
        },
        getPaddingSize = function(elem, options) {
            return getCssAttrSize(
                elem,
                $.extend({}, options, { attr: "padding" })
            );
        },
        getMarginSize = function(elem, options) {
            return getCssAttrSize(
                elem,
                $.extend({}, options, { attr: "margin" })
            );
        },
        getBorderSize = function(elem, options) {
            return getCssAttrSize(
                elem,
                $.extend({}, options, { attr: "border" })
            );
        },
        ...
        getOuterSize = function(elem) {
            ...
            return {
                width: os.width + ms.width,
                height: os.height + ms.height
            };
        },
        getInnerSize = function(elem) {
            ...
            return {
                width: cs.width - ps.width,
                height: cs.height - ps.height
            };
        },
        ...
        getElementSize = function(elem, basic) {
            ...
            var ps = getPaddingSize(elem),
                ...
                par = {
                    offsetWidth: os.width,
                    offsetHeight: os.height,
                    clientWidth: cs.width,
                    clientHeight: cs.height,
                    innerWidth: is.width,
                    innerHeight: is.height,
                    outerWidth: us.width,
                    outerHeight: us.height,
                    totalWidth: us.width,
                    totalHeight: us.height,
                    inner: is,
                    outer: us,
                    client: cs,
                    offset: os,
        ...
        setClass = function(elem, value, action) {
            ...
            for (var i = 0, c = elem.length; i < c; i++) {
                ...
                if (classes.length > 0) {
                    ...
                    cur =
                        elem[i].nodeType === 1 &&
                        stripAndCollapse(curValue).space();
                    if (cur) {
                        while ((css = classes[j++])) {
                            if ("toggle" === action) {
                                cur = setClassValue(
                                    cur,
                                    css,
                                    hasClass(elem[i], css) ? "remove" : "add"
                                );
                            } else {
        ...
        loadStaticFile = function(
            ...
            if (!$.isString(id, true)) {
                id =
                    nodeName +
                    "-" +
                    getFileName(path, true).replace(/[.]/, "-") +
                    "-" +
                    $.crc.toCRC16(path).toLowerCase();
            }
            ...
            if (
                $.isFunction(ae) &&
                ae.toString() &&
                ae.toString().indexOf("[native code]") >= 0
            ) {
                node.attachEvent("onreadystatechange", function(ev) {
                    onFileLoad(ev, path);
                });
            } else {
        ...
        addEventListener = function(elem, evName, func, useCapture, isRemove) {
            ...
            for (var i in events) {
                ...
                for (var j in elems) {
                    var o = elems[j];
                    if (
                        ($.isElement(o) || $.isDocument(o) || $.isWindow(o)) &&
                        $.isFunction(func)
                    ) {
                        normal
                            ? o[name](evn, func, useCapture || false)
                            : o[other]("on" + evn, func);
                    }
                }
            }
        ...
        addKeyListener = function(elem, evName, keyCode, func, isShiftKey) {
            ...
            var callback = function(ev) {
                ...
                if (typeof keyCode === "undefined") {
                    ...
                    e.key.toUpperCase() === keyCode.toUpperCase()
                ) {
        ...
        addHitListener = function(
            ...
            var callback = function(ev) {
                ...
                console.log(
                    "HitListener: ",
                    evName + (keyCode ? ":" + keyCode : ""),
                    e.keyCode || "",
                    elem[keyCount]
                );
                if (elem[keyCount] >= times) {
                    try {
                        func(e, elem[keyCount]);
                    } catch (e) {}
                    elem[keyCount] = 1;
                    elem[keyTimes] = 0;
                    return false;
        ...
        disableEvent = function(elem, evName, func) {
            if (
                $.isElement((elem = $.toElement(elem))) &&
                $.isString(evName, true)
            ) {
        ...
        setFocus = function(elem) {
            try {
                return isElement(elem) ? elem.focus() || true : false;
            } catch (e) {
                return false;
            }
        },
        ...
        getScrollPosition = function() {
            ...
            if (typeof window.pageYOffset !== "undefined") {
                ...
                typeof doc.compatMode !== "undefined" &&
        ...
        toggleDisplay = function(elem, options, func) {
            ...
            if (opt.size) {
                ...
                w = opt.show
                    ? parseInt("0" + opt.width, 10) || elem.widthCache
                    : 0;
                h = opt.show
                    ? parseInt("0" + opt.height, 10) || elem.heightCache
                    : 0;
        ...
        trigger = function(elem, evName) {
            ...
            var isEvent = document.createEvent ? true : false,
                ev;
            ...
            if ($.isWindow(elem) || $.isDocument(elem) || $.isElement(elem)) {
                if (
                    elem.tagName === "A" &&
                    (evName === "href" || evName.indexOf("click") > -1)
                ) {
                    elem.click();
                } else {
                    isEvent
                        ? elem["dispatchEvent"](ev)
                        : elem["fireEvent"](evName);
                }
            } else if ($.isArray(elem)) {
            ...
            if ($.isElement(obj)) {
                ...
                if (parent !== null) {
                    return parent.tagName === tagName
                        ? parent
                        : findParentElement(parent, tagName);
                }
            }
            return null;
        },
        ...
        setCookie = function(name, value, expireMinutes) {
            if (!$.isNumber(expireMinutes) || expireMinutes <= 0) {
                ...
                document.cookie =
                    name + "=" + escape(value) + ";expires=" + dt.toGMTString();
            }
            return this;
        },
        ...
        delCookie = function(name) {
            ...
            if (val !== null) {
                document.cookie =
                    name + "=" + val + ";expires=" + dt.toGMTString();
            }
            return this;
        },
    ...
    var browser = {
        ...
        isFirefox: function(ua) {
            return (ua || browser.ua()).indexOf("Firefox") > -1;
        },
        isEdge: function(ua) {
            return (ua || browser.ua()).indexOf("Edge") > -1;
        },
        isOpera: function(ua) {
            ua = ua || browser.ua();
        ...
        isIE: function(ua) {
            ...
            return (
                ...
                (ua.indexOf("MSIE") > -1 && ua.indexOf("compatible") > -1)
            );
        },
        ...
        isWechar: function(ua) {
            ua = ua || browser.ua();
            return /MicroMessenger/i.test(ua);
        },
        isMobile: function(ua) {
            return browser.isWap(ua);
        }
    };
    var ua = (function() {
            try {
        ...
        isChrome =
            !isOpera && !isEdge && !isSafari && ua.indexOf("Chrome") > -1,
        isIE =
            ua.indexOf("Trident") > -1 ||
            (ua.indexOf("MSIE") > -1 && ua.indexOf("compatible") > -1),
...
!(function($) {
    ...
    if (typeof window === "object") {
        ...
        $.extend($, {
            matchCondition: function(elements, options) {
                ...
                var checkParent = $.isElement(parent) || $.isDocument(parent),
                    checkTag =
                        ($.isString(tagNames, true) && tagNames !== "*") ||
                        $.isArray(tagNames),
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if (!pass) {
                        continue;
                    } else if ($.isBoolean(checked)) {
                        pass = obj.checked === checked;
                    }
                    if (!pass) {
                        continue;
                    } else if (checkValue) {
                        pass = values.indexOf(obj.value) >= 0;
                    }
                    if (!pass) {
                        continue;
                    } else if (checkTag) {
                        pass = tagNames.indexOf(obj.tagName) >= 0;
                    }
                    if (!pass) {
                        continue;
                    } else if (checkType) {
                        pass = types.indexOf(obj.type) >= 0;
                    }
                    if (!pass) {
                        continue;
                    } else if ($.isBoolean(disabled)) {
                        pass = obj.disabled === disabled;
                    }
                    if (!pass) {
                        continue;
                    } else if (checkParent) {
                        pass = obj.parentNode === parent;
                    }
                    if (!pass) {
                        continue;
                    } else if (checkAttr) {
        ...
        var wst = window.setTimeout,
            wsi = window.setInterval,
            cwst = window.clearTimeout,
            cwsi = window.clearInterval;
            ...
            getCheckedValues: function(selector, options) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if (hasParent && elem.parentNode !== options.parent) {
                        ...
                        hasRoot &&
                        !$.isChildNode(options.root, elem, true)
                    ) {
                        continue;
                    }
                    var val = elem.value;
            ...
            */
            ...
            checkInputKey: function(ev, codes, excepts, shift) {
                ...
                if (!shift && e.shiftKey && keyCode !== 9) {
                    ...
                    return (
                        (codes || []).indexOf(keyCode) >= 0 &&
                        (excepts || []).indexOf(keyCode) < 0
                    );
                }
            },
            // 设置输入框内容格式
            ...
            setInputFormat: function(elements, options) {
                var elems = [],
                    elem,
                    keyTypes = ["char", "number", "control", "symbol"];
                ...
                var types =
                        $.isArray(opt.types) && opt.types.length > 0
                            ? opt.types
                            : keyTypes,
                    excepts =
                        $.isArray(opt.excepts) && opt.excepts.length > 0
                            ? opt.excepts
                            : [],
                    keys = [
                        8, // backspace
            ...
            getElementValue: function(
                ...
                var elems =
                        $.isArray(elements) || $.isArrayLike(elements)
                            ? elements
                            : [elements],
            ...
            callbackParent: function(funcName) {
                if (top.location.href !== location.href) {
                    if (
                        $.isString(funcName, true) &&
                        funcName.indexOf("parent.") < 0
                    ) {
...
!(function($) {
    ...
    function ajax(url, options) {
        ...
        if (o.dataType === "JSONP" && o.jsonp !== false) {
            return (
                ajaxJSONP(o.url, o.jsonp, o.jsonpCallback, o.callback) || false
            );
        ...
        xhr.onreadystatechange = function() {
            ...
            if (200 === xhr.status) {
                ...
                $.isFunction(o.error)
                    ? o.error(o.result, xhr.statusText, xhr)
                    : $.throwError(o.result);
            }
            xhr = null;
        };
    ...
    var jsonp_idx = 1,
        checkOptions = function(url, o) {
            ...
            if ($.isArray(o.url)) {
                o.url =
                    (o.url[0] || "").toString().split("?")[0] +
                    (o.url[1] ? "?" + o.url.slice(1).join("&") : "");
        ...
        ajaxJSONP = function(url, jsonp, jsonpCallback, callback) {
            ...
            if (!jsonpCallback || true) {
                jsonpCallback =
                    "jsonpCallback_" + new Date().getTime() + "_" + jsonp_idx++;
        ...
        isStaticFile = function(o) {
            if (o.dataType === "HTML" || o.dataType === "SCRIPT") {
                ...
                return /(html|htm|txt|json|js)/gi.test($.getExtension(o.url));
            }
        },
        ...
        build = function(url, data, callback, dataType, method) {
            if ($.isFunction(data)) {
                (dataType =
                    callback || dataType), (callback = data), (data = null);
            }
            return {
                url: url,
                method: method,
        ...
        $,
        {
            ...
            getJSON: function(url, data, callback, checkException) {
                ...
                return ajax(
                    p.set({
                        dataType: "JSON",
                        checkException: $.isBoolean(p.dataType, false)
                    })
                );
            },
            ...
            getScript: function(url, data, callback, load) {
                ...
                return ajax(
                    p.set({
                        dataType: "SCRIPT",
                        load: $.isBoolean(p.dataType, false)
                    })
                );
            },
        ...
        $.fn,
        {
            ...
            prop: function(name, value) {
                ...
                if ($.isUndefined(value)) {
                    ...
                    return self.each(function(i, obj) {
                        obj[name] = value;
                    }), self;
                }
            },
    ...
    $.extendNative(
        $.fn,
        {
            ...
            click: function(func) {
                return this.event("click", func);
            },
            dblclick: function(func) {
                return this.event("dblclick", func);
            },
            blur: function(func) {
                return this.event("blur", func);
            },
            change: function(func) {
                return this.event("change", func);
            },
            focus: function(func) {
                return this.event("focus", func);
            },
            keydown: function(func) {
                return this.event("keydown", func);
            },
            keyup: function(func) {
                return this.event("keyup", func);
            },
            keypress: function(func) {
                return this.event("keypress", func);
            },
            mousedown: function(func) {
                return this.event("mousedown", func);
            },
            mouseup: function(func) {
                return this.event("mouseup", func);
            },
            mousemove: function(func) {
                return this.event("mousemove", func);
            }
        },
        "$.fn"
    );
            ...
            load: function(url, data, callback, dataType) {
                ...
                if (self.length > 0) {
                    ...
                    $.ajax(
                        p.set({
                            dataType: p.dataType || "HTML",
                            method: $.isObject(p.data) ? "POST" : p.method,
                            callback: function(data, status, xhr) {
                                self.html(data);

                                if ($.isFunction(func)) {
                                    self.each(function(data, status) {
                                        func(data, status);
                                    });
                                }
                            }
...
!(function($) {
    var getArguments = function(args, prefix) {
        ...
        log = function(type, formatstring) {
            var str =
                "[" +
                new Date().format(formatstring || _tf) +
                "]" +
                (type ? "[" + type + "]" : "");
            return str;
        },
        ...
        console: {
            ...
            log: function() {
                return console.log.apply(
                    this,
                    getArguments(arguments, log(null))
                ), this;
            },
            info: function() {
                return console.info.apply(
                    this,
                    getArguments(arguments, log("i"))
                ), this;
            },
            warn: function() {
                return console.warn.apply(
                    this,
                    getArguments(arguments, log("w"))
                ), this;
            },
            debug: function() {
                return console.debug.apply(
                    this,
                    getArguments(arguments, log("d"))
                ), this;
            },
            error: function() {
                return console.error.apply(
                    this,
                    getArguments(arguments, log("e"))
                ), this;
            },
            trace: function() {
                return console.trace.apply(
                    this,
                    getArguments(arguments, log("t"))
                ), this;
            }
        }
    });
    ...
    var callParentFunc = function(funcName, param) {
            if ($.isSubWindow()) {
                try {
                    var func = parent.$.dialog[funcName],
                        id = $.getQueryString(location.href, [
                            "dialog_id",
                            "dialogid"
                        ]);
        ...
        closeParentMenu = function(moduleName, funcName) {
            if ($.isSubWindow()) {
                try {
                    var func =
                        typeof parent.$[moduleName] !== "undefined"
                            ? parent.$[moduleName][funcName]
                            : null;
                    if ($.isFunction(func)) {
                        func();
                    }
